import 'package:alena/models/region.dart';
...
class RegionsScreen extends StatefulWidget {
  ...
  const RegionsScreen({Key key, this.regions, this.city}) : super(key: key);
          ...
          Padding(
                ...
                child: InkWell(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.adjust,color: Colors.grey[800],size: 18,),
                      const SizedBox(width: 5,),
                      Text('${widget.city} كلها',style: TextStyle(fontSize: 19,color: black),),
                    ],
                  ),
                ),
              ),
